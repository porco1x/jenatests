...
public class RDFtest extends Object {
    ...
    private static final void addTravelStuff(final Model model) {
        ...
        model.add(ba, RDFS.subPropertyOf, byTrain);
       ...
       createInfModel(model, byTrain);
    
    }
 
    private static void createInfModel(Model model, Property property) {
		
    	InfModel inf = ModelFactory.createRDFSModel(model);
    	Resource gatwick = inf.getResource(uri("Gatwick"));
    	System.out.println("Statement: " + gatwick.getProperty(property));
